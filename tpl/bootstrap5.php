...
?>
							...
							<button id="emaillink" type="button" data-timezone="<?php echo I18n::encode($MAILTIMEZONE); ?>" class="hidden btn btn-secondary flex-fill d-flex justify-content-center align-items-center gap-1">
